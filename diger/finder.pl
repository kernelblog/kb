...
print " Taramak istediğiniz web sitesini girin \n";
...
print "\n\n";
print " Web sitesinin kodlama dilini girin \n";
print" e.g.: asp, php, cfm, bilmiyorum\n";
print" Kodlamada kullanılan dili bilmiyorsanız, **bilmiyorum** \n";
print"--> ";
$code=<STDIN>;
chomp($code);
...
print "->Web site: $site\n";
print "->Web sitesinin kaynağı: $code\n";
print "->Yönetici kontrol panelinin taraması ilerliyor...\n\n\n";
...
print " \n [+] Bulunan -> $final\n\n";
print " \n Tebrikler, bu yönetici oturum açma sayfası çalışıyor. \n\n İyi şanslar \n\n";
}else{
